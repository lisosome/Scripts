...
dbNSFP_fields="Ensembl_transcriptid,Uniprot_acc,VEP_canonical,SIFT4G_score,SIFT4G_converted_rankscore,SIFT4G_pred,Polyphen2_HDIV_score,Polyphen2_HDIV_rankscore,Polyphen2_HDIV_pred,Polyphen2_HVAR_score,Polyphen2_HVAR_rankscore,Polyphen2_HVAR_pred,LRT_score,LRT_converted_rankscore,LRT_pred,LRT_Omega,MutationTaster_score,MutationTaster_converted_rankscore,MutationTaster_pred,MutationTaster_model,MutationTaster_AAE,MetaSVM_score,MetaSVM_rankscore,MetaSVM_pred,MetaLR_score,MetaLR_rankscore,MetaLR_pred,REVEL_score,REVEL_rankscore,ClinPred_score,ClinPred_rankscore,ClinPred_pred"
...
then
  ...
  do
    ...
    do
      ...
      ${vep_bin} -i ${infolder}/${chr}.vcf.gz --stats_text --force_overwrite --format vcf --offline --fasta /shared/resources/hgRef/hg38/Homo_sapiens_assembly38.fasta --compress_output bgzip --dir_plugins ${plugin_path} --o ${outfolder}/vep.${chr}.vcf.gz --buffer_size 200000 --plugin CADD,${cadd_whole_genome},${gnomad_indel},${gnomad_v} --custom ${gnomad_vcf},gnomADv3.1,vcf,exact,0,${gnomad_annot_string} --af_gnomad --af --af_1kg --af_esp --variant_class --regulatory --ccds --protein --uniprot --sift b --xref_refseq --hgvs --hgvsg --canonical --polyphen b --symbol --vcf --cache --merged --dir_cache ${maincache}/${vep_version} --assembly ${build} --plugin dbNSFP,${dbNSFP},${dbNSFP_fields} --plugin LoF,human_ancestor_fa:${maincache}/${vep_version}/loftee_data/human_ancestor.fa.gz,filter_position:0.05,min_intron_size:15,conservation_file:${maincache}/${vep_version}/loftee_data/phylocsf_gerp.sql,loftee_path:${plugin_path} --plugin Conservation,${gerp_db}
  done
fi
;;
  GRCh37)
...
${vep_bin} -i ${infolder}/${chr}_splitted.vcf.gz --stats_text --force_overwrite --format vcf --offline --fasta /shared/resources/gatk4hg19db/Homo_sapiens_assembly19_1000genomes_decoy.fasta --compress_output bgzip --dir_plugins ${plugin_path} --o ${outfolder}/vep.${chr}.vcf.gz --buffer_size 200000 --fork 12 --plugin dbNSFP,${dbNSFP},${dbNSFP_fields} --plugin CADD,${cadd_whole_genome},${gnomad_indel},${gnomad_v} --plugin Conservation,${gerp_db} --plugin ExACpLI,${plugin_path}/ExACpLI_values.txt --custom ${gnomad_vcf},gnomADv3.1,vcf,exact,0,${gnomad_annot_string} --af_gnomad --af --af_1kg --af_esp --variant_class --regulatory --ccds --protein --uniprot --sift b --xref_refseq --hgvs --hgvsg --canonical --polyphen b --symbol --vcf --cache --merged --dir_cache ${maincache}/${vep_version} --assembly ${build}
  ...
  do
    ...
    ${vep_bin} -i ${infolder}/${chr}.vcf.gz --stats_text --force_overwrite --format vcf --offline --fasta Homo_sapiens_assembly19_1000genomes_decoy.fasta --compress_output bgzip --dir_plugins ${plugin_path} --o ${outfolder}/vep.${chr}.vcf.gz --buffer_size 200000 --plugin CADD,${cadd_whole_genome},${gnomad_indel},${gnomad_v} --custom ${gnomad_vcf},gnomADv3.1,vcf,exact,0,${gnomad_annot_string} --af_gnomad --af --af_1kg --af_esp --variant_class --regulatory --ccds --protein --uniprot --sift b --xref_refseq --hgvs --hgvsg --canonical --polyphen b --symbol --vcf --cache --merged --dir_cache ${maincache}/${vep_version} --assembly ${build} --plugin dbNSFP,${dbNSFP},${dbNSFP_fields} --plugin LoF,human_ancestor_fa:${maincache}/${vep_version}/loftee_data/human_ancestor.fa.gz,filter_position:0.05,min_intron_size:15,conservation_file:${maincache}/${vep_version}/loftee_data/phylocsf_gerp.sql,loftee_path:${plugin_path} --plugin Conservation,${gerp_db}
done
fi
;;
esac
#--plugin CADD,${cadd_whole_genome},${gnomad_indel},${gnomad_v} --plugin dbNSFP,${dbNSFP},${dbNSFP_fields} --plugin LoF,human_ancestor_fa:${maincache}/${vep_version}/loftee_data/human_ancestor.fa.gz,filter_position:0.05,min_intron_size:15,conservation_file:${maincache}/${vep_version}/loftee_data/phylocsf_gerp.sql,loftee_path:${plugin_path} --plugin Conservation,${gerp_db}
#;;
#GWAS_BEST)
#if [[ $@ == "-h" ]]
#then
...
#done
#
#${vep_bin} --format id -i nome_file.txt --stats_text --force_overwrite  --offline --fasta /shared/resources/hgRef/hg38/Homo_sapiens_assembly38.fasta  --dir_plugins ${plugin_path} --o output_file.txt --buffer_size 200000 --fork 12 --plugin CADD,${cadd_whole_genome},${gnomad_indel},${gnomad_v} --custom ${gnomad_vcf},gnomADv3.1,vcf,exact,0,${gnomad_annot_string} --af_gnomad --af --af_1kg --af_esp --variant_class --regulatory --ccds --protein --uniprot --sift b --xref_refseq --hgvs --hgvsg --canonical --polyphen b --symbol --vcf --cache --merged --distance 250000 --dir_cache ${maincache}/${vep_version} --assembly ${build} --plugin dbNSFP,${dbNSFP},${dbNSFP_fields} --plugin Conservation,${gerp_db}
