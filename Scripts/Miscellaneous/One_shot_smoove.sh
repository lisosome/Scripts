...
#PBS -J 0-16
#PBS -o /large/___SCRATCH___/burlo/nardone/Smoove_test/pers_env_/test_821/smoove-script_call_${PBS_ARRAY_INDEX}.log
#PBS -e /large/___SCRATCH___/burlo/nardone/Smoove_test/pers_env_/test_821/smoove-script_call_${PBS_ARRAY_INDEX}.err
